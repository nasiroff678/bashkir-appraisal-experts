  ...
  return <section className="py-16 lg:py-24">
      <div className="container mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-heading font-bold text-foreground mt-2 mb-4">Наши преимущества</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {advantages.map((advantage, index) => <div key={index} className="flex gap-5 p-6 bg-card rounded-xl border border-border/50 card-shadow hover:card-shadow-hover transition-all duration-300 group">
              {/* Icon */}
